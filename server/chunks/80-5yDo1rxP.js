...
import { aj as news_errors_articleNotFound, al as news_errors_authorMemberNotFound } from './messages-D8OfyZiq.js';
...
import { u as updateSchema, a as updateArticle } from './actions2-BSfd5e_B.js';
...
const load = async ({ locals, params }) => {
  ...
  if (article?.author.id !== void 0) article.author.id = "";
  if (!article) throw error(404, news_errors_articleNotFound());
  ...
  if (!memberWithMandtes)
    throw error(500, news_errors_authorMemberNotFound());
