...
import { I as InventoryPage } from './InventoryPage-C2V0tbA_.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(InventoryPage, "InventoryPage").$$render($$result, { data }, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DGraQBAW.js.map
