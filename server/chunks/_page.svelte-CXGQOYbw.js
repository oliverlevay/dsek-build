...
import { S as SettingsPage } from './SettingsPage-BH448ypx.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SettingsPage, "SettingsPage").$$render($$result, { data }, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-CXGQOYbw.js.map
