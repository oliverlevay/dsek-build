...
import { C as CallbackPage } from './CallbackPage-CxdYGhYu.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(CallbackPage, "CallbackPage").$$render($$result, { data }, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-BwB6BCpf.js.map
