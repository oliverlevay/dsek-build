...
const load = async ({ locals }) => {
  ...
  const articles = await prisma.article.findMany({
    where: {
      ...
      publishedAt: {
        gte: /* @__PURE__ */ new Date("2024-01-01")
      }
    },
    orderBy: {
      publishedAt: "desc"
