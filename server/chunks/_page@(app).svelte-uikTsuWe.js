...
import { fN as events_editEvent } from './messages-D8OfyZiq.js';
...
const Page_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SetPageTitle, "SetPageTitle").$$render($$result, { title: events_editEvent() }, {}, {})} ${validate_component(EventEditor, "EventEditor").$$render(
    $$result,
    {
      data: data.form,
...
//# sourceMappingURL=_page@(app).svelte-uikTsuWe.js.map
