...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(SetPageTitle, "SetPageTitle").$$render($$result, { title: "Uppdatera biljett" }, {}, {})} ${validate_component(TicketForm, "TicketForm").$$render(
    $$result,
    {
      form: data.form,
      event: data.event,
...
//# sourceMappingURL=_page.svelte-BQUVw01C.js.map
